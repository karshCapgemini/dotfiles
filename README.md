...
* [`sys/cloud`](https://github.com/karnull/tree/sys/cloud):
    my self-hosted, customised linux mint server

* [`sys/darwin`](https://github.com/karnull/tree/sys/darwin):
    the main branch for my macos daily driver

* [`sys/edge`](https://github.com/karnull/tree/sys/edge):
    setup for my raspberrypi edge server

* [`sys/wsl`](https://github.com/karnull/tree/sys/wsl):
...
* [`x/tools`](https://github.com/karnull/tree/x/tools):
    Configs for tools I no longer use

* [`x/system`](https://github.com/karnull/tree/x/system):
